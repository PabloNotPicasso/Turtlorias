...
#else
#define __FORMAT_PRETTY_FUNCTION__ Logger::formatFunctionName(__FUNCTION__, __PRETTY_FUNCTION__)
#endif
...
#define LOG_FUNC_MSG(LOG_LEVEL, message)                                                           \
    LOG_MSG_IMPL(Logger::LogLevel::LOG_LEVEL, FORMAT_MSG(FUNCTION_NAME + " : " + message))
