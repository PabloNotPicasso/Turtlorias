...
////////////////////////////////////////////////////////////////////////////////////
// BitController
BoolVector::BitController::BitController(const size_t &globalIndex,
                                         byte &byteRef)
    : m_index(globalIndex % BIT_IN_BYTE), m_byte(byteRef) {}

BoolVector::BitController &
BoolVector::BitController::operator=(const BitController &bc) {
  setBit(bc);
  return *this;
}
...
BoolVector::BitController::operator bool() const { return getBit(); }
...
BoolVector::BoolVector(const size_t &size)
    : m_array(1 + size / BIT_IN_BYTE), m_size(size) {}
...
size_t BoolVector::capacity() const { return m_array.size() * BIT_IN_BYTE; }

size_t BoolVector::size() const { return m_size; }
...
void BoolVector::extend() { m_array.push_back(0); }
